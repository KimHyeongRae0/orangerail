/**
 * Orangerail action `updateCustomer` (Prisma update on model `Customer`).
 *
 * This file is yours — re-scans never modify it; `orangerail sync` reports drift.
 * Write operation: runs `prisma.customer.update(...)` against your database whenever the agent calls it.
...
export const updateCustomer = registry.defineAction({
  name: "updateCustomer",
  op: "update",
  input: z.object({
    "id": z.number().int(),
