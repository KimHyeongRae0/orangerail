/**
 * Orangerail action `createShop` (Prisma create on model `Shop`).
 *
 * This file is yours — re-scans never modify it; `orangerail sync` reports drift.
 * Write operation: runs `prisma.shop.create(...)` against your database whenever the agent calls it.
...
export const createShop = registry.defineAction({
  name: "createShop",
  op: "create",
  input: z.object({
