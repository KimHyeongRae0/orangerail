/**
 * Orangerail action `createOrderItem` (Prisma create on model `OrderItem`).
 *
 * This file is yours — re-scans never modify it; `orangerail sync` reports drift.
 * Write operation: runs `prisma.orderItem.create(...)` against your database whenever the agent calls it.
...
export const createOrderItem = registry.defineAction({
