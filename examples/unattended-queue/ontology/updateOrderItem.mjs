/**
 * Orangerail action `updateOrderItem` (Prisma update on model `OrderItem`).
 *
 * This file is yours — re-scans never modify it; `orangerail sync` reports drift.
 * Write operation: runs `prisma.orderItem.update(...)` against your database whenever the agent calls it.
...
export const updateOrderItem = registry.defineAction({
