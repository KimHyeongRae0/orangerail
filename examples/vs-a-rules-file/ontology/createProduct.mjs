/**
 * Orangerail action `createProduct` (Prisma create on model `Product`).
 *
 * This file is yours — re-scans never modify it; `orangerail sync` reports drift.
 * Write operation: staged for human approval; on approval it runs `prisma.product.create(...)` against your database.
 */
import { z } from 'zod';
...
export const createProduct = registry.defineAction({
  name: "createProduct",
  input: z.object({
    "id": z.string(),
    "title": z.string(),
