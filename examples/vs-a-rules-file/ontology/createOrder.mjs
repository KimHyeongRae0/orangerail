/**
 * Orangerail action `createOrder` (Prisma create on model `Order`).
 *
 * This file is yours — re-scans never modify it; `orangerail sync` reports drift.
 * Write operation: runs `prisma.order.create(...)` against your database whenever the agent calls it.
...
export const createOrder = registry.defineAction({
  name: "createOrder",
  op: "create",
  input: z.object({
    "id": z.string(),
