/**
 * Orangerail action `updateProduct` (Prisma update on model `Product`).
 *
 * This file is yours — re-scans never modify it; `orangerail sync` reports drift.
 * Write operation: staged for human approval; on approval it runs `prisma.product.update(...)` against your database.
 */
import { z } from 'zod';
...
export const updateProduct = registry.defineAction({
  name: "updateProduct",
  op: "update",
  input: z.object({
    "id": z.string(),
